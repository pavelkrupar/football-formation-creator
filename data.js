...
const playersByPosition = {
  ...
  'Obránci': [
    ...
    { id: 'p36', club: 'sparta', number: 22, name: 'Loïc Mbe Soh', role: 'CB', optimalPositions: ['CB'], compatiblePositions: [], marketValue: 2.0 },
    { id: 'p37', club: 'sparta', number: 25, name: 'Ki-Jana Hoever', role: 'RB', optimalPositions: ['RB', 'CB'], compatiblePositions: [], marketValue: 3.5 },
